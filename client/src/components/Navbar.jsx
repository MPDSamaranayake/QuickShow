  ...
  return (
    <nav>
      ...
      justify-between px-6 md:px-16 lg:px-36 py-5'>
        ...
        <div className={`md:hidden max-md:absolute max-md:top-0 max-md:left-0 max-md:font-medium max-md:text-lg z-50 flex flex-col md:flex-row items-center
        max-md:justify-center gap-8 min-md:px-8 py-3 max-md:h-screen
        max-md:rounded-full backdrop-blur bg-gray-700/70 md:bg-white/10 md:border
